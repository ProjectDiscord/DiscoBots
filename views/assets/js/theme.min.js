...
!(function () {
  ...
  null !== (t = document.querySelector('[data-bs-toggle="mode"]')) &&
    ...
    "light" === mode
      ? (root.classList.remove("dark-mode"), (e.checked = !1))
      : (root.classList.add("dark-mode"), (e.checked = !0)),
  ...
  function _0x5959() {
    const _0xd2ed3e = [
      ...
      "16erbEJZ",
      "red",
      "%cIf\x20you\x20need\x20any\x20help,\x20join\x20our\x20discord\x20server!\x20https://discord.gg/sQQFSnQhdt",
      "7513NQDpoy",
    ];
    _0x5959 = function () {
      return _0xd2ed3e;
